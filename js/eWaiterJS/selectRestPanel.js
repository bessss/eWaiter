...
function buttonClickSRP(index)
{
  ...
  mainObject.selectRestaurant.userSelect = true;
  $('.cssOver').remove();
...
{
  var obj = this;
  var tmpHeight = mainObject.selectRestaurant.restaurantStore.length*46;
  if (tmpHeight > 240 )
  {
    tmpHeight = 240;
  }

  if ( mainObject.selectRestaurant.userSelect == false )
  {
    this.panel = Ext.create('Ext.Panel',{
      ...
      width: 200,
      minHeight: '120px',
      maxHeight: $(document).height() - Ext.get('title').getHeight() + 'px',
      height: tmpHeight + 40,
      listeners: {
        hide: function(cmp,bug)
        {
          mainObject.selectRestaurant.userSelect = true;
        }
      },
      ...
      },
      {
        ...
        height: tmpHeight,
        minHeight: '80px',
        maxHeight: $(document).height() - Ext.get('title').getHeight() - 40 + 'px',
        height: 'auto',
